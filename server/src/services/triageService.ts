...
const CONDITION_DIAGNOSTICS: Record<string, string[]> = {
  ...
  difficulty_breathing: ['xcbx', 'oxygen_saturation', 'cbg'],
  high_fever: ['malaria_rdt', 'dengue_ns1', 'blood_sugar', 'cbc'],
  severe_burns: ['wound_culture', 'cbc'],
  severe_headache: ['cbg', 'bp_monitor'],
  unconscious: ['cbg', 'ecg', 'cbc', 'xcbx'],
  ...
  pregnancy_complication: ['blood_group', 'cbc', 'urinalysis', 'bp_monitor'],
